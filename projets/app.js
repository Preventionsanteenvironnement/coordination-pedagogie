...
const ETAPES = [
  ...
  { id:"cadre", nom:"Cadre", icon:"shield", q:"Quelles sont les limites du dispositif ?", def:"Ce que le dispositif ne fait pas. Le cadre protège le projet des dérives.", aide:"Ex. pas de sanction, pas de suivi psy, pas de remplacement du CPE…" },
  ...
  { id:"vigilance", nom:"Points de vigilance", icon:"alert", q:"Quels risques anticiper ?", def:"Les pièges à éviter pour que le projet ne dévie pas de son intention.", aide:"Ex. confusion avec la vie scolaire, sanction déguisée, espace refuge…" },
];
