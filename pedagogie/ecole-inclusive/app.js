...
============================================================================ */
const TYPE_LABEL = { loi: "Loi", reglement: "Réglementaire / officiel", convention: "Convention", ouvrage: "Ouvrage / ressource" };
...
function viewAccueil() {
  ...
  return `
    <div class="home-banner"><span>🏫</span><div><strong>École inclusive — guide de formation</strong>
      <small>Cadre &amp; dispositifs, comprendre les troubles, public, pédagogie adaptée, supports. Chaque notion renvoie à une source officielle ou de référence.</small></div></div>
    ...
    <p class="foot-note">Touche le <b>§</b> sous chaque notion pour voir la source (texte officiel / référence).</p>`;
}
