...
const THEMATIQUES = [
  ...
  },
  {
    ...
    enfants: [
      ...
      {
        titre: "Parcours de PFMP — construction collective",
        desc: "Atelier de l'équipe pédagogique : définir ensemble, étape par étape, les responsabilités de chaque acteur dans le parcours de PFMP de l'élève, de la recherche du stage au bilan (pré-convention, convention, attestation, allocation). Édition collaborative en temps réel et document de synthèse imprimable.",
        lien: "parcours-pfmp/",
  ...
  },
  {
    ...
    enfants: [
      ...
      {
        titre: "Référents de pôle",
        desc: "Pour les référents AESH de chaque pôle : les AESH et leurs heures, l'emploi du temps commun, les absences, les besoins estimés par les enseignants, les messages entre référents, l'export PDF et Excel. Code à quatre chiffres.",
        lien: "referents-aesh/",
        type: "Code d'accès",
        icon: "compass",
        badge: "Nouveau",
